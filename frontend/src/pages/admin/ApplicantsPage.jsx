...
import ApplicantWizard from '../../components/wizard/ApplicantWizard';
...
const ApplicantsPage = () => {
  ...
  const [showApplicantWizard, setShowApplicantWizard] = useState(false);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <Button onClick={() => setShowApplicantWizard(true)} className="flex items-center space-x-2">
      ...
      {/* Applicant Wizard Modal */}
      <ApplicantWizard 
        isOpen={showApplicantWizard}
        onClose={() => setShowApplicantWizard(false)}
      />
    </div>
  );
};
